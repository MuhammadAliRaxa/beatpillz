...
class SmtpController extends Controller
{
    ...
    public function test(Request $request)
    {
        ...
        try {
            $email = $request->email;
            Mail::html(
                '<p>Hello,</p><p>This is a BeatPillz SMTP delivery verification message.</p><p>If you received this email, the configured mail service successfully submitted the message for delivery.</p><p>Regards,<br>BeatPillz</p>',
                function ($message) use ($email) {
                    $message->to($email)
                        ->subject('BeatPillz SMTP Delivery Verification');
                }
            );
